...
public class ApneaGraph extends Activity {
    LuxDB luxDB;
    Start_UserDB start_userDB;
    SQLiteDatabase sql;
    Button DayApneaDataButton, WeekApneaDataButton, MountApneaDataButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {        //전반적인 소스코드가 LuxGraph와 유사함. 해당 클래스 주석 참고
        ...
        setContentView(R.layout.graph_apnea);
        ...
        DayApneaDataButton = (Button)findViewById(R.id.button9);
        DayApneaDataButton.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        WeekApneaDataButton = (Button)findViewById(R.id.button21);
        WeekApneaDataButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                valsComp1.clear();
                xVals.clear();
        ...
        MountApneaDataButton = (Button)findViewById(R.id.button22);
        MountApneaDataButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                valsComp1.clear();
                xVals.clear();
