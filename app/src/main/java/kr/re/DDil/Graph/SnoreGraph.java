...
public class SnoreGraph extends Activity{
    LuxDB luxDB;
    Start_UserDB start_userDB;
    SQLiteDatabase sql;
    Button DaySnoreDataButton, WeekSnoreDataButton, MountSnoreDataButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {    //전반적인 소스코드가 LuxGraph와 유사함. 해당 클래스 주석 참고
        ...
        setContentView(R.layout.graph_snore);
        ...
        DaySnoreDataButton = (Button)findViewById(R.id.button10);
        DaySnoreDataButton.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        WeekSnoreDataButton = (Button)findViewById(R.id.button11);
        WeekSnoreDataButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                valsComp1.clear();
                xVals.clear();
        ...
        MountSnoreDataButton = (Button)findViewById(R.id.button13);
        MountSnoreDataButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                valsComp1.clear();
                xVals.clear();
